# T-236: Nigeria — Lekki British School (High School) world-class profile build
...
- `tickets/T-203-nigeria-ng-lagos-lekki-british-profile.md`
...
- [ ] Data rows in `countries/nigeria/data/entities/schools.csv` (and any country-specific high-potential CSV) mirror the profile for `Lekki British School (High School)`: slug, city, tier, curricula, affordability signals, program-fit tags, evidence/source references, and `last_verified` date are consistent.
...
- Closed and superseded by T-254.
