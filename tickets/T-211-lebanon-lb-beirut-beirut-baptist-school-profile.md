# T-211: Lebanon — Beirut Baptist School world-class profile build
...
Claimed-by: work
Claimed-at: 2025-12-20T22:39:33Z
...
Produce a world-class, deeply researched high school profile for **Beirut Baptist School** in **Beirut, Lebanon**, aligned to the global template and synced with the country schools dataset so recruiting teams can execute outreach with confidence.
...
- Priority tier / notes: Support/cost-of-living $4,972 for Grades 9–12 (2024-25); Tier: Medium; source https://bbs.edu.lb/new/tuition-fees/?utm_source=openai (school_id: lb-beirut-beirut-baptist-school)

---

## Allowed write paths

- `tickets/T-178-lebanon-lb-beirut-beirut-baptist-school-profile.md`
...
- `countries/lebanon/entities/schools/profiles/lb-beirut-beirut-baptist-school/README.md` created or refreshed using the global high school profile template with completed snapshot, affordability, curriculum, outcomes, outreach plan, and sources.
- `countries/lebanon/data/entities/schools.csv` row for `lb-beirut-beirut-baptist-school` updated with city/region, curriculum, priority tier, affordability evidence, and last_verified tied to the source report.
...
- [ ] Data rows in `countries/lebanon/data/entities/schools.csv` (and any country-specific high-potential CSV) mirror the profile for `Beirut Baptist School`: slug, city, tier, curricula, affordability signals, program-fit tags, evidence/source references, and `last_verified` date are consistent.
...
- What changed (2025-12-20): Added Beirut Baptist School profile using global template, refreshed CSV row with USD fee evidence and contacts, and linked profile from schools index.
