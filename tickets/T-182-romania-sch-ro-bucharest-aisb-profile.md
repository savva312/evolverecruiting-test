# T-182: Romania — American International School of Bucharest world-class profile build
...
- `tickets/T-149-romania-sch-ro-bucharest-aisb-profile.md`
...
- [ ] Data rows in `countries/romania/data/entities/schools.csv` (and any country-specific high-potential CSV) mirror the profile for `American International School of Bucharest`: slug, city, tier, curricula, affordability signals, program-fit tags, evidence/source references, and `last_verified` date are consistent.
...
- Closed and superseded by T-244.
