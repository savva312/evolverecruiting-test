# T-187: Romania — International Computer High School of Bucharest world-class profile build
...
- `tickets/T-154-romania-sch-ro-bucharest-ichb-profile.md`
...
- [ ] Data rows in `countries/romania/data/entities/schools.csv` (and any country-specific high-potential CSV) mirror the profile for `International Computer High School of Bucharest`: slug, city, tier, curricula, affordability signals, program-fit tags, evidence/source references, and `last_verified` date are consistent.
...
- Closed and superseded by T-245.
