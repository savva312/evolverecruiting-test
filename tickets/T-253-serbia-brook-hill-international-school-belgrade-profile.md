# T-253: Serbia — Brook Hill International School (Belgrade) world-class profile build
...
- `tickets/T-220-serbia-brook-hill-international-school-belgrade-profile.md`
...
- [ ] Data rows in `countries/serbia/data/entities/schools.csv` (and any country-specific high-potential CSV) mirror the profile for `Brook Hill International School (Belgrade)`: slug, city, tier, curricula, affordability signals, program-fit tags, evidence/source references, and `last_verified` date are consistent.
...
- Closed and superseded by T-268.
