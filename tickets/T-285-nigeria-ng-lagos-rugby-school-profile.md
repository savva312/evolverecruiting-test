# T-285: Nigeria — Rugby School Nigeria world-class profile build
...
What-changed: Built full Rugby School Nigeria profile with website evidence and synced schools.csv row; added sources and outreach plan.
...
Produce a world-class, deeply researched high school profile for **Rugby School Nigeria** in **Lagos, Nigeria**, aligned to the global template and synced with the country schools dataset so recruiting teams can execute outreach with confidence.
...
- Priority tier / notes: Priority Tier1 from Nigeria Premium Secondary School Pipeline (school_id: ng-lagos-rugby-school)

---

## Allowed write paths

- `tickets/T-253-nigeria-ng-lagos-rugby-school-profile.md`
...
- `countries/nigeria/entities/schools/profiles/lagos/rugby-school-nigeria/README.md` created or refreshed using the global high school profile template with completed snapshot, affordability, curriculum, outcomes, outreach plan, and sources.
- `countries/nigeria/data/entities/schools.csv` row for `ng-lagos-rugby-school` updated with city/region, curriculum, priority tier, affordability evidence, and last_verified tied to the source report.
...
- [ ] Data rows in `countries/nigeria/data/entities/schools.csv` (and any country-specific high-potential CSV) mirror the profile for `Rugby School Nigeria`: slug, city, tier, curricula, affordability signals, program-fit tags, evidence/source references, and `last_verified` date are consistent.
