# T-301: Serbia — Gimnazija “Crnjanski” (IB DP) world-class profile build
...
Claimed-by: work
Claimed-at: 2025-12-21T10:22:47+00:00
...
- `tickets/T-269-serbia-gimnazija-crnjanski-belgrade-profile.md`
...
- [x] Data rows in `countries/serbia/data/entities/schools.csv` (and any country-specific high-potential CSV) mirror the profile for `Gimnazija “Crnjanski” (IB DP)`: slug, city, tier, curricula, affordability signals, program-fit tags, evidence/source references, and `last_verified` date are consistent.
...
- 2025-12-21: Profile and CSV updated; sources expanded; ticket completed.
