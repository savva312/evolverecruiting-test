# T-243: Serbia — Ruđer Bošković (IB pathway) world-class profile build
...
- `tickets/T-210-serbia-ruder-boskovic-ib-profile.md`
...
- [ ] Data rows in `countries/serbia/data/entities/schools.csv` (and any country-specific high-potential CSV) mirror the profile for `Ruđer Bošković (IB pathway)`: slug, city, tier, curricula, affordability signals, program-fit tags, evidence/source references, and `last_verified` date are consistent.
...
- Closed and superseded by T-260.
