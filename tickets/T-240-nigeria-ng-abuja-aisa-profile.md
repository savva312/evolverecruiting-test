# T-240: Nigeria — American International School of Abuja (AISA) world-class profile build
...
Produce a world-class, deeply researched high school profile for **American International School of Abuja (AISA)** in **Abuja, Nigeria**, aligned to the global template and synced with the country schools dataset so recruiting teams can execute outreach with confidence.
...
- Priority tier / notes: Priority Tier1 from Nigeria Premium Secondary School Pipeline (school_id: ng-abuja-aisa)

---

## Allowed write paths

- `tickets/T-207-nigeria-ng-abuja-aisa-profile.md`
...
- `countries/nigeria/entities/schools/profiles/abuja/american-international-school-of-abuja-aisa/README.md` created or refreshed using the global high school profile template with completed snapshot, affordability, curriculum, outcomes, outreach plan, and sources.
- `countries/nigeria/data/entities/schools.csv` row for `ng-abuja-aisa` updated with city/region, curriculum, priority tier, affordability evidence, and last_verified tied to the source report.
...
- [ ] Data rows in `countries/nigeria/data/entities/schools.csv` (and any country-specific high-potential CSV) mirror the profile for `American International School of Abuja (AISA)`: slug, city, tier, curricula, affordability signals, program-fit tags, evidence/source references, and `last_verified` date are consistent.
...
- 2025-12-21: Profile refreshed; CSV/index updates deferred intentionally to avoid conflicts with parallel tickets.

---

## Closure notes

- Closed and superseded by T-257.
