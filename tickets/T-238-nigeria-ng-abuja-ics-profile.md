# T-238: Nigeria — International Community School (ICS) Abuja world-class profile build
...
- `tickets/T-205-nigeria-ng-abuja-ics-profile.md`
...
- [ ] Data rows in `countries/nigeria/data/entities/schools.csv` (and any country-specific high-potential CSV) mirror the profile for `International Community School (ICS) Abuja`: slug, city, tier, curricula, affordability signals, program-fit tags, evidence/source references, and `last_verified` date are consistent.
...
- Closed and superseded by T-256.
