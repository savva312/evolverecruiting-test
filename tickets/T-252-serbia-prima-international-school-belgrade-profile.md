# T-252: Serbia — PRIMA International School of Belgrade world-class profile build
...
Claimed-by: work
Claimed-at: 2025-12-21T08:03:55Z
...
Produce a world-class, deeply researched high school profile for **PRIMA International School of Belgrade** in **Belgrade, Serbia**, aligned to the global template and synced with the country schools dataset so recruiting teams can execute outreach with confidence.
...
- Priority tier / notes: Affordability tier Medium-High per Serbia pipeline index (school_id: prima-international-school-belgrade)

---

## Allowed write paths

- `tickets/T-219-serbia-prima-international-school-belgrade-profile.md`
...
- `countries/serbia/entities/schools/profiles/belgrade/prima-international-school-belgrade/README.md` created or refreshed using the global high school profile template with completed snapshot, affordability, curriculum, outcomes, outreach plan, and sources.
- `countries/serbia/data/entities/schools.csv` row for `prima-international-school-belgrade` updated with city/region, curriculum, priority tier, affordability evidence, and last_verified tied to the source report.
...
- [ ] Data rows in `countries/serbia/data/entities/schools.csv` (and any country-specific high-potential CSV) mirror the profile for `PRIMA International School of Belgrade`: slug, city, tier, curricula, affordability signals, program-fit tags, evidence/source references, and `last_verified` date are consistent.
...
- Created full template-aligned profile for PRIMA International School of Belgrade using source report and school site evidence; CSV/index updates intentionally deferred to avoid conflicts per instruction.
