# T-204: Romania — British International School of Timișoara world-class profile build
...
Claimed-by: work
Claimed-at: 2025-12-20T22:38:01Z
...
Produce a world-class, deeply researched high school profile for **British International School of Timișoara** in **Timișoara, Romania**, aligned to the global template and synced with the country schools dataset so recruiting teams can execute outreach with confidence.
...
- Priority tier / notes: Priority tier A per feeder map (school_id: sch-ro-timisoara-bist)

---

## Allowed write paths

- `tickets/T-171-romania-sch-ro-timisoara-bist-profile.md`
...
- `countries/romania/entities/schools/profiles/sch-ro-timisoara-bist/README.md` created or refreshed using the global high school profile template with completed snapshot, affordability, curriculum, outcomes, outreach plan, and sources.
- `countries/romania/data/entities/schools/romania-high-potential-feeder-high-schools.csv` entry for `sch-ro-timisoara-bist` aligned to the profile (tier, affordability signal, program-fit tags, sources).
- `countries/romania/data/entities/schools.csv` row for `sch-ro-timisoara-bist` updated with city/region, curriculum, priority tier, affordability evidence, and last_verified tied to the source report.
...
- [x] Data rows in `countries/romania/data/entities/schools.csv` (and any country-specific high-potential CSV) mirror the profile for `British International School of Timișoara`: slug, city, tier, curricula, affordability signals, program-fit tags, evidence/source references, and `last_verified` date are consistent.
...
**What changed:** Created full profile for sch-ro-timisoara-bist, refreshed both Romania school datasets with aligned fields/sources, and linked the profile from the Romania schools index.
