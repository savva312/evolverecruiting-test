# T-239: Nigeria — Lycée Français Marcel-Pagnol d’Abuja (LFMPA) world-class profile build
...
Produce a world-class, deeply researched high school profile for **Lycée Français Marcel-Pagnol d’Abuja (LFMPA)** in **Abuja, Nigeria**, aligned to the global template and synced with the country schools dataset so recruiting teams can execute outreach with confidence.
...
- Priority tier / notes: Priority Tier1 from Nigeria Premium Secondary School Pipeline (school_id: ng-abuja-lycee-francais)

---

## Allowed write paths

- `tickets/T-206-nigeria-ng-abuja-lycee-francais-profile.md`
...
- `countries/nigeria/entities/schools/profiles/abuja/lyc-e-fran-ais-marcel-pagnol-d-abuja-lfmpa/README.md` created or refreshed using the global high school profile template with completed snapshot, affordability, curriculum, outcomes, outreach plan, and sources.
- `countries/nigeria/data/entities/schools.csv` row for `ng-abuja-lycee-francais` updated with city/region, curriculum, priority tier, affordability evidence, and last_verified tied to the source report.
...
- [ ] Data rows in `countries/nigeria/data/entities/schools.csv` (and any country-specific high-potential CSV) mirror the profile for `Lycée Français Marcel-Pagnol d’Abuja (LFMPA)`: slug, city, tier, curricula, affordability signals, program-fit tags, evidence/source references, and `last_verified` date are consistent.
...
What changed (2025-12-21): Profile expanded for LFMPA with French Bac positioning, fee evidence, outreach plan, and sources. CSV/index left untouched per instruction.
