# T-251: Serbia — British International School (Belgrade) world-class profile build
...
- `tickets/T-218-serbia-british-international-school-belgrade-profile.md`
...
- [ ] Data rows in `countries/serbia/data/entities/schools.csv` (and any country-specific high-potential CSV) mirror the profile for `British International School (Belgrade)`: slug, city, tier, curricula, affordability signals, program-fit tags, evidence/source references, and `last_verified` date are consistent.
...
- Closed and superseded by T-267.
