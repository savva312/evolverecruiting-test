# T-292: Serbia — Ruđer Bošković (IB pathway) world-class profile build
...
Claimed-by: work
Claimed-at: 2025-12-21T10:17:30Z
Last-updated: 2025-12-21

Progress note (2025-12-21): School profile drafted; index/README/CSV intentionally left untouched to avoid conflicts as requested.

Completion note (2025-12-21): Updated school profile + CSV with 2025/26 tuition, contacts, outreach plan, and sources; ready for recruiting use.

---

## Goal

Produce a world-class, deeply researched high school profile for **Ruđer Bošković (IB pathway)** in **Belgrade, Serbia**, aligned to the global template and synced with the country schools dataset so recruiting teams can execute outreach with confidence.
...
- Priority tier / notes: Affordability tier High per Serbia pipeline index (school_id: ruder-boskovic-ib)

---

## Allowed write paths

- `tickets/T-260-serbia-ruder-boskovic-ib-profile.md`
...
- `countries/serbia/entities/schools/profiles/belgrade/ruder-boskovic-ib/README.md` created or refreshed using the global high school profile template with completed snapshot, affordability, curriculum, outcomes, outreach plan, and sources.
- `countries/serbia/data/entities/schools.csv` row for `ruder-boskovic-ib` updated with city/region, curriculum, priority tier, affordability evidence, and last_verified tied to the source report.
...
- [x] Data rows in `countries/serbia/data/entities/schools.csv` (and any country-specific high-potential CSV) mirror the profile for `Ruđer Bošković (IB pathway)`: slug, city, tier, curricula, affordability signals, program-fit tags, evidence/source references, and `last_verified` date are consistent.
