# T-214: Lebanon — Lycée franco-libanais Verdun world-class profile build
...
Claimed-by: work
Claimed-at: 2025-12-20T22:39:43Z
...
Produce a world-class, deeply researched high school profile for **Lycée franco-libanais Verdun** in **Beirut, Lebanon**, aligned to the global template and synced with the country schools dataset so recruiting teams can execute outreach with confidence.
...
- Priority tier / notes: USD development contribution $2,900 (2025-26); Tier: Medium; source https://www.lycee-verdun.edu.lb/inscriptions25-26-2/?utm_source=openai (school_id: lb-beirut-lycee-verdun)

---

## Allowed write paths

- `tickets/T-181-lebanon-lb-beirut-lycee-verdun-profile.md`
...
- `countries/lebanon/entities/schools/profiles/lb-beirut-lycee-verdun/README.md` created or refreshed using the global high school profile template with completed snapshot, affordability, curriculum, outcomes, outreach plan, and sources.
- `countries/lebanon/data/entities/schools.csv` row for `lb-beirut-lycee-verdun` updated with city/region, curriculum, priority tier, affordability evidence, and last_verified tied to the source report.
...
- [ ] Data rows in `countries/lebanon/data/entities/schools.csv` (and any country-specific high-potential CSV) mirror the profile for `Lycée franco-libanais Verdun`: slug, city, tier, curricula, affordability signals, program-fit tags, evidence/source references, and `last_verified` date are consistent.
...
What changed: Created full profile for Lycée franco-libanais Verdun, updated the Lebanon schools CSV with curricula/tier/affordability evidence, and aligned sources to the USD feeder report.
