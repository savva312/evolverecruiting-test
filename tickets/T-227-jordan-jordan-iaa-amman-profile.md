# T-227: Jordan — International Academy – Amman (IAA) world-class profile build
...
Claimed-by: work
Claimed-at: 2025-12-20T22:43:15+00:00
...
Produce a world-class, deeply researched high school profile for **International Academy – Amman (IAA)** in **Amman, Jordan**, aligned to the global template and synced with the country schools dataset so recruiting teams can execute outreach with confidence.
...
- Priority tier / notes: Priority tier Tier 1; evidence B/C (school_id: jordan-iaa-amman)

---

## Allowed write paths

- `tickets/T-194-jordan-jordan-iaa-amman-profile.md`
...
- `countries/jordan/entities/schools/profiles/amman/international-academy-amman-iaa/README.md` created or refreshed using the global high school profile template with completed snapshot, affordability, curriculum, outcomes, outreach plan, and sources.
- `countries/jordan/data/entities/schools.csv` row for `jordan-iaa-amman` updated with city/region, curriculum, priority tier, affordability evidence, and last_verified tied to the source report.
...
- [x] Data rows in `countries/jordan/data/entities/schools.csv` (and any country-specific high-potential CSV) mirror the profile for `International Academy – Amman (IAA)`: slug, city, tier, curricula, affordability signals, program-fit tags, evidence/source references, and `last_verified` date are consistent.
...
**What changed (2025-12-20):** Added full IAA profile using global template, refreshed CSV row with admissions contact + curriculum and fee-verification notes, and linked the profile from the Jordan schools index.
