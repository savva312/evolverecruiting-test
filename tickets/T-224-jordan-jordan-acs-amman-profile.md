# T-224: Jordan — American Community School Amman world-class profile build
...
Claimed-by: work
Claimed-at: 2025-12-20T22:42:00Z
...
Produce a world-class, deeply researched high school profile for **American Community School Amman** in **Amman, Jordan**, aligned to the global template and synced with the country schools dataset so recruiting teams can execute outreach with confidence.
...
- Priority tier / notes: Priority tier Tier 1; evidence A (school_id: jordan-acs-amman)

---

## Allowed write paths

- `tickets/T-191-jordan-jordan-acs-amman-profile.md`
...
- `countries/jordan/entities/schools/profiles/amman/american-community-school-amman/README.md` created or refreshed using the global high school profile template with completed snapshot, affordability, curriculum, outcomes, outreach plan, and sources.
- `countries/jordan/data/entities/schools.csv` row for `jordan-acs-amman` updated with city/region, curriculum, priority tier, affordability evidence, and last_verified tied to the source report.
...
- [ ] Data rows in `countries/jordan/data/entities/schools.csv` (and any country-specific high-potential CSV) mirror the profile for `American Community School Amman`: slug, city, tier, curricula, affordability signals, program-fit tags, evidence/source references, and `last_verified` date are consistent.
...
- What changed: ACS profile enriched with website source, outreach plan, logistics assumptions, and CSV row aligned with visit windows, affordability signals, and sources.
