# T-245: Serbia — International School (LINK/Savremena) world-class profile build
...
- `tickets/T-212-serbia-savremena-international-school-profile.md`
...
- [ ] Data rows in `countries/serbia/data/entities/schools.csv` (and any country-specific high-potential CSV) mirror the profile for `International School (LINK/Savremena)`: slug, city, tier, curricula, affordability signals, program-fit tags, evidence/source references, and `last_verified` date are consistent.
...
- Closed and superseded by T-261.
