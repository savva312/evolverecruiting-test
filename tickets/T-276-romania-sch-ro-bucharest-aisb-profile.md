# T-276: Romania — American International School of Bucharest world-class profile build
...
Claimed-by: work
Claimed-at: 2025-12-21T10:15:00Z
...
Produce a world-class, deeply researched high school profile for **American International School of Bucharest** in **Bucharest, Romania**, aligned to the global template and synced with the country schools dataset so recruiting teams can execute outreach with confidence.
...
- Priority tier / notes: Priority tier A per feeder map (school_id: sch-ro-bucharest-aisb)

---

## Allowed write paths

- `tickets/T-244-romania-sch-ro-bucharest-aisb-profile.md`
...
- `countries/romania/entities/schools/profiles/sch-ro-bucharest-aisb/README.md` created or refreshed using the global high school profile template with completed snapshot, affordability, curriculum, outcomes, outreach plan, and sources.
- `countries/romania/data/entities/schools/romania-high-potential-feeder-high-schools.csv` entry for `sch-ro-bucharest-aisb` aligned to the profile (tier, affordability signal, program-fit tags, sources).
- `countries/romania/data/entities/schools.csv` row for `sch-ro-bucharest-aisb` updated with city/region, curriculum, priority tier, affordability evidence, and last_verified tied to the source report.
...
- [x] Data rows in `countries/romania/data/entities/schools.csv` (and any country-specific high-potential CSV) mirror the profile for `American International School of Bucharest`: slug, city, tier, curricula, affordability signals, program-fit tags, evidence/source references, and `last_verified` date are consistent.
...
- Created AISB profile using the global template with recruitment plan, tuition/affordability notes, and source links; synced AISB rows in romania-high-potential-feeder-high-schools.csv and schools.csv to match the profile. (2025-12-21)
