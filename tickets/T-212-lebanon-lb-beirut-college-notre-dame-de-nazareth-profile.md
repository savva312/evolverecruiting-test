# T-212: Lebanon — Collège Notre-Dame de Nazareth world-class profile build
...
Claimed-by: work
Claimed-at: 2025-12-20T22:40:22+00:00
Last-updated: 2025-12-20
What-changed: Created initial profile for Collège Notre-Dame de Nazareth, updated Lebanon schools CSV, and linked profile from schools README.

---

## Goal

Produce a world-class, deeply researched high school profile for **Collège Notre-Dame de Nazareth** in **Beirut, Lebanon**, aligned to the global template and synced with the country schools dataset so recruiting teams can execute outreach with confidence.
...
- Priority tier / notes: USD tuition $3,980 for Seconde–Terminale (2024-25); Tier: Medium; source https://ndn.edu.lb/ecolages/?utm_source=openai (school_id: lb-beirut-college-notre-dame-de-nazareth)

---

## Allowed write paths

- `tickets/T-179-lebanon-lb-beirut-college-notre-dame-de-nazareth-profile.md`
...
- `countries/lebanon/entities/schools/profiles/lb-beirut-college-notre-dame-de-nazareth/README.md` created or refreshed using the global high school profile template with completed snapshot, affordability, curriculum, outcomes, outreach plan, and sources.
- `countries/lebanon/data/entities/schools.csv` row for `lb-beirut-college-notre-dame-de-nazareth` updated with city/region, curriculum, priority tier, affordability evidence, and last_verified tied to the source report.
...
- [x] Data rows in `countries/lebanon/data/entities/schools.csv` (and any country-specific high-potential CSV) mirror the profile for `Collège Notre-Dame de Nazareth`: slug, city, tier, curricula, affordability signals, program-fit tags, evidence/source references, and `last_verified` date are consistent.
