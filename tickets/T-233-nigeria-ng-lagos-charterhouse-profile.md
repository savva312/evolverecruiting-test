# T-233: Nigeria — Charterhouse Lagos world-class profile build
...
- `tickets/T-200-nigeria-ng-lagos-charterhouse-profile.md`
...
- [ ] Data rows in `countries/nigeria/data/entities/schools.csv` (and any country-specific high-potential CSV) mirror the profile for `Charterhouse Lagos`: slug, city, tier, curricula, affordability signals, program-fit tags, evidence/source references, and `last_verified` date are consistent.
...
- Closed and superseded by T-251.
