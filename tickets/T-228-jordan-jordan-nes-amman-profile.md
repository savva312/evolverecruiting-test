# T-228: Jordan — New English School (NES) world-class profile build
...
Claimed-by: work
Claimed-at: 2025-12-21T07:57:58Z
Last-updated: 2025-12-21
What-changed: NES Amman profile created, CSV row updated, index linked.

---

## Goal

Produce a world-class, deeply researched high school profile for **New English School (NES)** in **Amman, Jordan**, aligned to the global template and synced with the country schools dataset so recruiting teams can execute outreach with confidence.
...
- Priority tier / notes: Priority tier Tier 1; evidence A (school_id: jordan-nes-amman)

---

## Allowed write paths

- `tickets/T-195-jordan-jordan-nes-amman-profile.md`
...
- `countries/jordan/entities/schools/profiles/amman/new-english-school-nes/README.md` created or refreshed using the global high school profile template with completed snapshot, affordability, curriculum, outcomes, outreach plan, and sources.
- `countries/jordan/data/entities/schools.csv` row for `jordan-nes-amman` updated with city/region, curriculum, priority tier, affordability evidence, and last_verified tied to the source report.
...
- [ ] Data rows in `countries/jordan/data/entities/schools.csv` (and any country-specific high-potential CSV) mirror the profile for `New English School (NES)`: slug, city, tier, curricula, affordability signals, program-fit tags, evidence/source references, and `last_verified` date are consistent.
