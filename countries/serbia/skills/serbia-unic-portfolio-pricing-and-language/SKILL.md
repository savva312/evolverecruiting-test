---
name: serbia-unic-portfolio-pricing-and-language
description: Maintain a Serbia-ready, source-backed inventory of UNIC Nicosia and UNIC Athens programs (what’s offered, language of instruction, tuition/fees, intakes, admissions requirements, and Serbia-facing notes). Produces both structured CSVs and per-program markdown profiles for consistent counseling, pricing transparency, and cluster mapping.
metadata:
  owner: evobuilder
  version: "1.0"
  scope: serbia
...
# Serbia: UNIC portfolio, pricing, and language (skill)

## Purpose
Serbian recruiting becomes operationally reliable only if we have a **single, maintained source of truth** for:
...
- Serbia-facing notes (recognition links, degree awarding institution, etc.)
...
3) **Separate “published facts” from “recommended Serbia tactics.”**
...
- `notes_serbia` (short: only Serbia-relevant facts like recognition link targets, common doc expectations)
...
- Serbia-facing notes (recognition links to use; typical parent questions)
...
- Add a “Serbia-ready counseling note” section that is strictly factual:
...
- A downstream agent can build Serbia landing pages or scripts without re-researching tuition/program facts.
