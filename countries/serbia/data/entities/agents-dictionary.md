...
| --- | --- | --- | --- | --- |
| agent_id | Stable unique identifier for the agency. | string | `ag-rs-belgrade-uni-001` | Lowercase, ASCII. |
| name | Agency name. | string | `FuturePath Education` | Use registered/brand name. |
| region | Primary operating region in Serbia. | string | `Belgrade` | City/region text. |
...
| contact_name | Lead contact. | string | `Milan Jovanović` | Person responsible for Serbia. |
| contact_email | Contact email. | string (email) | `milan.jovanovic@example.rs` | Lowercase. |
