...
- **Country codes:** ISO 3166-1 alpha-2 for `country` columns (e.g., `RS`, `CY`).
- **Regions/cities:** Free text; follow Serbian official spellings in English (e.g., `Belgrade`, `Novi Sad`).
- **Web/email:** `https://`-prefixed URLs; emails in lowercase ASCII.
- **Phone numbers:** E.164 format if added (e.g., `+381...`).
