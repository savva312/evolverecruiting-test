# School outreach playbook (Romania)
Last updated: 2025-12-20 | Owner: School outreach lead (TBD)

## Targeting priorities (use T-007 profiles)
- **Bucharest (international & language schools)** — first wave; pull counselor names and past notes from `entities/schools/profiles/sofia/README.md`.
- **Cluj-Napoca bilingual/STEM schools** — second wave; confirm program fit via `entities/schools/profiles/plovdiv/README.md`.
- **Constanta/coastal language schools** — third wave; pair with fairs/agent events; see `entities/schools/profiles/varna/README.md`.
- **Other cities (Iasi, Timisoara, Brasov)** — opportunistic; log findings in `entities/schools/profiles/other/README.md`.
...
- **Affordability** — outline tuition vs. UK/EU comparables; highlight scholarships/discounts for Romanian students (placeholder link).  
- **Mobility & safety** — 1-hour flight from Bucharest to Larnaca/Athens; campus safety; housing support.  
...
- **Bucharest** — weekly half-days; cluster 3–4 schools per trip; prioritize schools with past interest in T-007 profiles.  
- **Cluj-Napoca** — 1x per month; bundle with agent check-ins; aim for Thursday/Friday slots for student attendance.  
- **Constanta/coastal** — every 6–8 weeks; stack with fairs; pre-book two school stops per trip.  
- **Virtual** — monthly counselor update call (zoom); invite all regions to reduce travel gaps.

## Next actions
- Lock top 10 Bucharest/Cluj-Napoca targets from T-007 profiles and secure January/February dates. **Owner:** Outreach lead.  
- Finalize dual-campus one-pagers + short intro video links (placeholders acceptable). **Owner:** Marketing.  
- Set up shared tracker for call outcomes and visit status in `/executions/`. **Owner:** Ops support.
