---
name: romania-unic-portfolio-pricing-and-language
description: Maintain a Romania-ready, source-backed inventory of UNIC Nicosia and UNIC Athens programs (what’s offered, language of instruction, tuition/fees, intakes, admissions requirements, and Romania-facing notes). Produces both structured CSVs and per-program markdown profiles for consistent counseling, pricing transparency, and cluster mapping.
metadata:
  owner: evobuilder
  version: "1.0"
  scope: romania
...
# Romania: UNIC portfolio, pricing, and language (skill)

## Purpose
Romanian recruiting becomes operationally reliable only if we have a **single, maintained source of truth** for:
...
- Romania-facing notes (recognition links, degree awarding institution, etc.)
...
3) **Separate “published facts” from “recommended Romania tactics.”**
...
- `notes_romania` (short: only Romania-relevant facts like recognition link targets, common doc expectations)
...
- Romania-facing notes (recognition links to use; typical parent questions)
...
- Add a “Romania-ready counseling note” section that is strictly factual:
...
- A downstream agent can build Romania landing pages or scripts without re-researching tuition/program facts.
