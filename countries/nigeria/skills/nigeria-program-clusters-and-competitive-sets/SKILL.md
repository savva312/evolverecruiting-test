---
name: nigeria-program-clusters-and-competitive-sets
description: Define and maintain Nigeria-specific program clusters and competitive sets for recruiting, including competitor mapping and portfolio alignment.
metadata:
  owner: evobuilder
  version: "1.0"
  scope: nigeria
...
# Nigeria Program Clusters and Competitive Sets

This skill defines how EvoBuilder should organize Nigeria recruitment intelligence by **program cluster** (e.g., Medicine vs CS/Data vs Business) and maintain a **Nigeria-relevant competitive set** for each cluster.

It exists because Nigerian families do not “choose a university” in the abstract — they shortlist **by program**, and the competitor set for Medicine is completely different from the competitor set for CS/Data, Psychology, Business, etc.

---

## How this relates to the global skill

Use the global workflow in [`skills/program-clusters-and-competitor-sets/SKILL.md`](/skills/program-clusters-and-competitor-sets/SKILL.md) for definitions, steps, and templates. This Nigeria file serves as a country addendum: keep Nigeria-specific cluster taxonomy choices and any Nigeria-only nuances here, and point tickets to the global skill for the end-to-end process.
...
- “Create competitor profiles for Nigeria decision makers”
- “Update pricing + language-of-instruction tables by cluster”
- “Compare UNIC Athens vs UNIC Nicosia vs competitors (Nigeria lens)”
...
- A similar Nigeria buyer journey (student/parent motivations, timing, proof needed)
...
### Competitive set
A **competitive set** is the small list of institutions/programs Nigerian families *actually compare* against UNIC Athens / UNIC Nicosia for that cluster.

It should be:
- **Nigeria-relevant** (realistic shortlists for Nigerian candidates)
...
## Recommended cluster set for Nigeria recruiting repos

See the country addendum below for the Nigeria-specific cluster taxonomy currently in use. Use the global baseline unless Nigeria-specific demand signals require a different grouping.
...
- “Why it competes” (the reason RO families compare it)
- Source links
...
### Step 3 — Define Nigeria decision logic for the cluster
Write (briefly, but concretely):

- Nigeria student persona(s) for this cluster
...
- **Nigeria domestic** options (when they truly compete)
- **Greece** (especially Athens/Thessaloniki) options
- **Cyprus** options
- **CEE** options (common for Medicine especially)
- **Western Europe** options (Germany/NL/etc.) when capacity/brand makes them appear on Nigerian shortlists
- **Private EU English-taught** institutions that Nigeria families actually consider

For each competitor, record:
- why it competes for this cluster (one sentence)
- a source link for tuition + admissions mechanism

Avoid “random lists”. Every competitor must be justified by Nigeria relevance.
...
### 2) Nigeria decision journey (what matters)
- Personas:
- Proof required:
- Timing constraints:
- Objections:

### 3) Competitive set (Nigeria-relevant)
#### A) Greece
- ...
#### B) Cyprus
- ...
#### C) CEE / Other EU
- ...
#### D) Nigeria domestic (only if relevant)
- ...

### 4) Positioning and messaging (Nigeria lens)
...
## Why it matters for Nigeria (cluster-specific)
- Cluster(s):
- Why Nigerian students compare it:

## Programs that compete (Nigeria-relevant only)
...
- A competitive set exists with justified, Nigeria-relevant competitors
...
- Mixing “Europe recruiting” generalities into Nigeria-specific artifacts
- Listing competitors without explaining why Nigerians compare them
- Writing strategy without updating CSVs (the repo becomes non-operational)
- Writing outside ticket boundaries

---

## Nigeria addendum: cluster taxonomy and notes

Use this grouping when working in Nigeria unless a ticket specifies otherwise:

1. **medicine-and-health**
   - Includes MD and any health/allied health programs marketed to Nigeria.
2. **computing-data-ai**
...
5. **law-and-governance**
   - Law programs where Athens/Nicosia differences matter for Nigeria prospects.
6. **design-and-creative**
   - Design and creative programs marketed to Nigeria.
7. **other-strategic-programs**
   - Only when a Nigeria demand signal and distinct competitor set are documented (e.g., Pharmacy if actively marketed).

If a proposed “cluster” would not change the competitive set or channel strategy for Nigeria, keep it inside an existing cluster.
...
- Nigeria relevance is the filter: if you can’t explain why it competes, omit it.
