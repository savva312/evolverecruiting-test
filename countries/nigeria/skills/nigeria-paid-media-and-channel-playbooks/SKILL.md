---
name: nigeria-paid-media-and-channel-playbooks
description: Build and maintain Nigeria-specific paid media + channel playbooks (Search/Meta/TikTok/YouTube/retargeting/messaging), tied to Nigeria’s calendar and UNIC/UNIC Athens program clusters. Produces executable campaign structures, creative briefs/copy libraries, KPI guardrails, and structured CSVs for tracking spend, UTMs, CPL/CPA, and funnel performance.
metadata:
  owner: evobuilder
  version: "1.0"
  scope: nigeria
...
# Nigeria: paid media & channel playbooks (skill)
...
- Use this Nigeria file for calendar, flighting, localization, consent, and compliance specifics that layer onto the global spec.

### Nigeria addendum: localization and compliance anchors
- Language and tone: EN primary; add Nigerian English variants and Pidgin where appropriate for social hooks; keep landing pages in EN with clear tuition and recognition statements.
- Messaging channels: WhatsApp/SMS only with explicit opt-in; avoid cold outreach. Observe NCC/NDPR consent and storage expectations.
- Payments/claims: No financing promises; avoid statements about visa guarantees or post-study work. For Medicine/health programs, include recognition/licensure disclaimers and source links.

## Purpose
This skill turns Nigeria recruiting strategy into **executable, measurable acquisition** across digital channels—without drifting into generic EU recruiting advice.

It produces:
- Nigeria-specific channel strategy by **program cluster** (e.g., Medicine vs CS/Data/AI vs Business, etc.)
...
- “Nigeria paid media plan” (budget, channels, flighting, KPIs)
- “Search keyword plan for Nigeria” (RO + EN queries, negatives)
- “Meta/TikTok creative system + copy library (Nigerian)”
...
- Nigeria education calendar + exam blackouts
- Priority schools + city clusters (Lagos / Abuja / Port Harcourt / Kano + regional)
...
- Nigeria-specific seasonality + flighting (Jan–Oct; exam blackouts)
- Creative system + hooks (by persona/cluster)
- Landing page requirements (Nigeria-ready)
...
### C) Copy blocks (Nigerian + English)
...
### Step 1 — Anchor to Nigeria’s calendar (non-negotiable)
Use the repo’s Nigeria calendar skill outputs to define:
...
Deliverable: a short “flight map” table for Nigeria.

### Step 2 — Define personas per cluster
At minimum:
- Student (high intent) + Parent (co-decision) + Counselor/Agent influence
- Nigeria-specific variations (Lagos IB school vs regional elite science school, etc.)
...
- Hooks must be Nigeria-relevant (proximity, calendar deadlines, transparent cost)
...
Define the minimum LP elements to match Nigeria expectations:
...
These are starting points; calibrate using historical Nigeria results if available.
...
- Generic EU recruiting advice (not Nigeria-specific)
...
- There is an executable Nigeria channel plan tied to calendar windows
