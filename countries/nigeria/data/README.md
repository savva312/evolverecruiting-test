...
This folder houses structured, machine-readable datasets to support recruiting operations for UNIC and UNIC Athens from Nigeria. All CSVs should use UTF-8 encoding with headers in the first row. Prefer narrow, tidy tables with clear data dictionaries in adjacent notes when fields are non-obvious.
