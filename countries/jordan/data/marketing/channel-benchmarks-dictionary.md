...
| source_period | Timeframe/source window. | string | `2025-Q4` | Use period formats from `field-standards.md`. |
| sample_size | Size of sample used. | integer | `1200` | Leave blank if unknown. |
| notes | Context, targeting, methodology. | string | `Jordan paid social pilots; youth 17–24` | Concise. |
