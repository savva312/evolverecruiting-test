...
- **Country codes:** ISO 3166-1 alpha-2 for `country` columns (e.g., `BG`, `CY`).
- **Regions/cities:** Free text; follow Bulgarian official spellings in English (e.g., `Sofia`, `Plovdiv`).
