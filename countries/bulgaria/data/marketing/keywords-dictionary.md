...
| audience | Target audience description. | string | `HS seniors in Sofia` | Short segment description. |
| est_cpc_eur | Estimated cost-per-click in EUR. | decimal | `0.85` | Numeric only. |
| search_volume_bg | Average monthly searches in Bulgaria. | integer | `5400` | Leave blank if unknown. |
