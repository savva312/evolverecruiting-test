...
| degree_level | Degree level. | enum | `bachelor` | Suggested: `bachelor`, `master`, `doctoral`, `certificate`, `professional-doctorate`, `other`. Use `professional-doctorate` for integrated 6-year Medicine/MD degrees. |
