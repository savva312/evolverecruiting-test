...
Schema reference for `unic-programs.csv`. Apply `field-standards.md` for shared conventions.
...
| notes | Admissions or positioning notes. | string | `STEM scholarships for LB students` | Concise. |
