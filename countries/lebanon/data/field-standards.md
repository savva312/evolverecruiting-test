...
- **Country codes:** ISO 3166-1 alpha-2 for `country` columns (e.g., `LB`, `CY`).
- **Regions/cities:** Free text; follow Lebanese official spellings in English (e.g., `Beirut`, `Tripoli`).
- **Web/email:** `https://`-prefixed URLs; emails in lowercase ASCII.
- **Phone numbers:** E.164 format if added (e.g., `+961...`).
