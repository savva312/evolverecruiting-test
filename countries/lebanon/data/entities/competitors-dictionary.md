...
| target_programs | Programs/fields they market in Lebanon. | multi-enum | `medicine;business` | Semicolon-separated list. |
| lb_presence | Presence footprint in Lebanon. | enum | `local_agent` | Suggested: `none`, `local_agent`, `rep_office`, `alumni_network`, `digital_only`, `other`. |
| notes | Positioning, pricing cues, source links. | string | `Strong scholarship offers; runs Beirut fairs` | Concise. |
